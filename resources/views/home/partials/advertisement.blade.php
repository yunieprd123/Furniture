		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="abt-bg">
						<a href="https://youtu.be/sBtYWK817-0?si=UjZcPHLVDwCjQzmT" class="video-play-btn popup-youtube"><i class="fas fa-play"></i></a>
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<a href="{{ route('home.tentang-kami') }}" class="boxed-btn mt-4">know more</a>
					</div>
				</div>
			</div>
		</div>
